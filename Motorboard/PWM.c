...
void INIT_TIM(TIM_TypeDef* TIMx, vu16 Auto_Reload_Preload_Enable, vu16  Alignment, vu16 One_Pulse_Mode, vu16 Count_Direction,  vu16 Update_Request_Source, vu16 Prescaler, vu16 Clock_Division, vu16 Update_Disable){

TIMx->CR1 = (uint16_t)((Clock_Division << 8)|(Auto_Reload_Preload_Enable << 7)|(Alignment << 6)|(Count_Direction << 4)|(One_Pulse_Mode << 3)|(Update_Request_Source << 2)|(Update_Disable << 1));
